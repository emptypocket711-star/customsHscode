...
| P170.1 product candidate detail handoff regression | 대기 | E2E 실행 경로가 아니라 품명 검색 10자리 후보를 눌러 직접조회로 들어갈 때 source/basis date/간략정보 맥락이 유지되는지 검증한다 | product candidate detail handoff | browser, typecheck, lint |
