...
| P219.1 operations metrics action labels | 예정 | 운영 홈 액션 레일이 아니라 운영 통계 카드 숫자가 무엇을 의미하고 다음 행동이 무엇인지 더 직접적으로 표시한다 | operations metrics simplification | metric labels, copy regression |
