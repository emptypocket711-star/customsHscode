...
| P71.4 clearance list status browser review | 예정 | 운송 목록 검증이 아니라 통관 요청 목록에서도 선정·진행·완료 다음 작업 라벨이 실제 화면에서 어색하지 않은지 확인한다 | clearance list browser review | browser, typecheck, lint |
