...
| P69.2 requester detail bid-focus review | 예정 | 대시보드가 상세로 바로 가는 링크가 아니라 상세 도착 후 견적 비교·선정 영역이 충분히 빨리 보이는지 점검한다 | requester detail bid focus | UX review, browser, typecheck, lint |
