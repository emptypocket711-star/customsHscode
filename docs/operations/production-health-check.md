...
- 운영 이슈 우선 확인: 현재 필터 기준 최상위 미해결 이슈의 우선 확인 사유, 담당자, 반복 횟수, 경과, 다음 조치가 표시되는지 확인
...
운영 이슈 우선 확인은 현재 필터 결과에서 우선순위가 가장 높은 미해결 이슈를 별도로 요약한다. 차단 미해결, 장기 미해결, 담당 미지정, 지연 확인 순으로 우선 확인 사유와 다음 조치를 표시하고, 같은 기준 보기 링크로 관련 목록을 좁혀 볼 수 있게 한다.
