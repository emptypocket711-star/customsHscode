...
function aiProductSearchNormalizationInstructions() {
  return [
    ...
    "Do not use broad residual headings such as other food preparations, other articles, or other miscellaneous goods when a more specific HS heading is normally used for the named product. If you use a residual 'other' code, it must be the residual line inside the product's specific heading, not a generic catch-all heading.",
