...
function aiProductSearchNormalizationInstructions() {
  return [
    ...
    "If visible words are insufficient to identify even a broad HS4/HS6 product family, set classificationState=needs_clarification, displayMode=needs_more_info, and ask for product category, use, material, catalog page, photo, or specification sheet.",
