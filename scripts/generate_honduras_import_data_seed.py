...
OUTPUT = ROOT / "supabase/seed/generated/honduras_import_data_seed.sql"

SOURCE_VERSION = "honduras-import-data-20260524"
SAR_ISV_SOURCE_URL = "https://www.sar.gob.hn/impuesto-sobre-ventas-isv/"
ADUANAS_TARIFF_SOURCE_URL = "https://www.aduanas.gob.hn/seccion-clasificacion-arancelaria/"
SENASA_ANIMAL_SOURCE_URL = "https://senasa.gob.hn/rq-dia-001-requisitos-deimportacion-para-productos-de-origen-animal-a-honduras/"
SENASA_LANAR_SOURCE_URL = "https://senasa.gob.hn/laboratorio-nacional-de-analisis-de-residuos-lanar/"
ARSA_FAQ_SOURCE_URL = "https://arsa.gob.hn/preguntas-frecuentes/"
ARSA_FOOD_SOURCE_URL = "https://new.arsa.gob.hn/registros-sanitarios-alimentos-y-bebidas/"
ARSA_PHARMA_SOURCE_URL = "https://arsa.gob.hn/productos-farmaceuticos/"
CONATEL_SOURCE_URL = "https://www.conatel.gob.hn/homologaciones/"
CONATEL_REQUIREMENT_SOURCE_URL = "https://www.conatel.gob.hn/doc/simplificacion/requisitos/15.%20REQUISITOS%20PARA%20SOLICITAR%20CERTIFICADO%20DE%20HOMOLOGACI%C3%93N%20DE%20EQUIPOS%20V.2.pdf"
...
REQUIREMENTS = [
    {
        ...
        "name": "온두라스 동물·동물성 제품 SENASA 확인",
        "agency": "SENASA / Administración Aduanera de Honduras",
        "basis": "SENASA requirements for importation of animal-origin products to Honduras",
        "summary": "동물, 축산물, 수산물, 동물성 원료, 가죽·모피·양모 등은 SENASA 동물검역, 수입허가, 위생증명서, 잔류물질 검사 확인 대상 가능성이 있습니다.",
        ...
        "source_name": "SENASA animal-origin import requirements",
    ...
    },
    {
        ...
        "name": "온두라스 식품·농산물·식물검역 ARSA/SENASA 확인",
        "agency": "ARSA / SENASA / Administración Aduanera de Honduras",
        "basis": "ARSA food and beverage sanitary registration; SENASA food safety and residue analysis controls",
        "summary": "식품, 농산물, 식물, 종자, 곡물, 음료, 사료류는 ARSA 식품·음료 위생등록, SENASA 검역·잔류물질 검사, 라벨·성분 확인 대상 가능성이 있습니다.",
        "documents": ["상업송장", "포장명세서", "성분표", "제품 라벨", "식물검역/위생증명서(해당 시)", "ARSA/SENASA 등록 또는 허가자료(해당 시)"],
        "notes": "식품/음료/사료/재식용, 원산국, 가공도, 위생등록 대상과 검역 위험에 따라 요구자료가 달라질 수 있습니다.",
        "source_name": "ARSA food and beverage sanitary registration",
        "source_url": ARSA_FOOD_SOURCE_URL,
    },
    {
        ...
        "name": "온두라스 의약품·의료기기 ARSA 등록 확인",
        "agency": "ARSA / Administración Aduanera de Honduras",
        "basis": "ARSA sanitary registration for pharmaceutical products, medical devices and health-interest products",
        "summary": "의약품, 원료의약품, 의료기기, 체외진단기기는 ARSA 위생등록, 수입자 라이선스, 제품분류, 통제물질 여부 확인 대상 가능성이 있습니다.",
        "documents": ["상업송장", "포장명세서", "제품 사양서", "성분표 또는 분류자료", "ARSA 등록 또는 허가자료(해당 시)", "라벨/사용설명서"],
        "notes": "의약품/의료기기/식품보조제/화장품 분류, 등록제품 여부, 통제물질 함량, 상호인정 대상 여부에 따라 절차가 달라질 수 있습니다.",
        "source_name": "ARSA pharmaceutical products",
        "source_url": ARSA_PHARMA_SOURCE_URL,
    },
    {
        ...
        "name": "온두라스 화장품·위생제품 ARSA 등록 확인",
        "agency": "ARSA / Administración Aduanera de Honduras",
        "basis": "ARSA procedures for cosmetics, hygienic products, pesticides and health-interest products",
        "summary": "화장품, 퍼스널케어, 세정제, 위생제품, 살충·소독 제품은 ARSA 위생등록, 성분·라벨, 제품분류 확인 대상 가능성이 있습니다.",
        "documents": ["상업송장", "포장명세서", "전성분표", "제품 라벨", "제품 사양서", "ARSA 등록자료(해당 시)"],
        "notes": "치료·살균 효능, 제한성분, 화장품/의약품/위생제품/농약 분류와 스페인어 표시 여부에 따라 관할과 요건이 달라질 수 있습니다.",
        "source_name": "ARSA frequently asked questions",
        "source_url": ARSA_FAQ_SOURCE_URL,
    },
    {
        ...
        "name": "온두라스 화학물질·위험제품 확인",
        "agency": "ARSA / SENASA / Administración Aduanera de Honduras",
        "basis": "ARSA controlled substances and health-interest product procedures; customs classification context",
        "summary": "화학물질, 혼합물, 위험물, 세정제, 플라스틱·고무 원료는 MSDS, 위험물 분류, 제한물질, ARSA 등록 또는 관할기관 승인 확인 대상 가능성이 있습니다.",
    ...
    },
    {
        ...
        "name": "온두라스 통신·무선기기 CONATEL homologación 확인",
        "agency": "CONATEL / Administración Aduanera de Honduras",
        "basis": "CONATEL homologation requirements for telecommunications equipment and devices",
        "summary": "통신장비, 이동통신 단말, 무선기기, IoT, 네트워크 장비는 CONATEL homologación, 주파수·기술기준, 단말 모델 확인 대상 가능성이 있습니다.",
        "documents": ["상업송장", "포장명세서", "제품 사양서", "무선/통신 기능 설명", "시험성적서", "CONATEL homologación 자료(해당 시)"],
        "notes": "무선기기 여부, 공중망 접속, 주파수 사용, 판매용/샘플 여부와 인정 가능한 FCC/CE/IFETEL/TELEC 인증 여부에 따라 절차가 달라질 수 있습니다.",
        "source_name": "CONATEL homologation requirements",
        "source_url": CONATEL_REQUIREMENT_SOURCE_URL,
    },
]
...
select
  ...
  encode(digest('HND|' || heading.destination_hs_code || '|' || {sql(requirement["type"])} || '|' || {sql(requirement["name"])} || '|' || {sql(SOURCE_VERSION)}, 'sha256'), 'hex')
from (
  ...
  where country_code = 'HND'
    and source_version = 'customs-country-tariff-20251231:HND'
...
"""
    ...
    output = f"""-- Generated by scripts/generate_honduras_import_data_seed.py
...
select
  ...
  '15%',
  '온두라스 수입 ISV 표준세율 후보',
  'SAR 안내 기준 ISV는 수입과 판매 단계에 적용되는 비누적 판매세이며, 일반세율은 15%입니다. 특정 품목의 면세·비과세·차등세율과 특별세는 별도 확인이 필요합니다.',
  'SAR Impuesto Sobre Ventas',
  {sql(SAR_ISV_SOURCE_URL)},
  ...
  now(),
  'staged'::public.legal_record_status,
  encode(digest('HND|vat|' || tariff.destination_hs_code || '|' || {sql(SOURCE_VERSION)}, 'sha256'), 'hex')
from (
