...
const dataManagementGuide = [
  {
    label: "매일",
    title: "차단·중요 변경만 확인",
    detail: "게시 차단, 중요 변경, 적재 문제가 없으면 세부 표와 실행 도구는 열지 않아도 됩니다."
  },
  {
    label: "자료 갱신 때",
    title: "갱신·게시 실행",
    detail: "공식자료를 새로 받은 날에만 API 연결, 집계 갱신, 게시 전환을 순서대로 확인합니다."
  },
  {
    label: "문제 발생 때",
    title: "상세 데이터 추적",
    detail: "커버리지, 원천 버전, 누락 항목, 실행 체크리스트는 이상 원인을 추적할 때만 펼칩니다."
  }
];
