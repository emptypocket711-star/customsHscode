          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
            <div className="grid gap-4">
              <div className="grid gap-4 md:grid-cols-[1fr_140px]">
                ...
                {hskCodeError ? (
                  <button
                    className="inline-flex cursor-not-allowed items-center justify-center gap-2 self-end rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-400"
                    disabled
                    type="button"
                  >
