...
export function HsConfirmationRequestForm({
  ...
  return (
    <form action={formAction} className="mt-3 grid gap-2">
      ...
      <button
        className="focus-ring inline-flex items-center justify-center gap-2 rounded-md bg-blue-700 px-3 py-2 text-sm font-semibold text-white hover:bg-blue-800 disabled:cursor-not-allowed disabled:bg-slate-600 disabled:text-white"
        disabled={pending}
        type="submit"
      >
